...
import { ArrowUpRight, Mail, ArrowDownToLine } from "lucide-react";
...
export default function NavBar({
  ...
  return (
    <>
      ...
      {showContactDialog && (
        <motion.div
          className="fixed inset-0 w-screen h-screen bg-black/50 backdrop-blur-sm flex items-center justify-center z-30 font-sans"
