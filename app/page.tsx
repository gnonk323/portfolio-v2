...
export default function Home() {
  return (
    <>
      <ParticlesBackground />
      <div className="font-sans fixed top-0 w-screen py-4 px-8 flex items-center justify-between z-20 mix-blend-difference">
        <div>
      ...
      <div className="font-sans relative z-10">
        <div className="h-screen flex flex-col items-center justify-center gap-4 text-center text-xl">
        ...
        <div className="bg-foreground text-background p-8">
          <h2 className="font-doto font-bold text-3xl mb-8">ABOUT ME</h2>
        ...
        <div className="h-16" />
        <div className="bg-foreground text-background p-8">
          <h2 className="font-doto font-bold text-3xl mb-8">PROJECTS</h2>
        ...
        <div className="bg-foreground text-background p-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            <a className="rounded-full px-3 py-1 border border-background font-semibold flex items-center gap-2 hover:bg-background hover:text-foreground transition-colors cursor-pointer">
